...
const resources = {
  en: {
    translation: {
      ...
      cta: { title: "Own a business?", body: "Claim your spot on Spott. Connect with locals, respond to reviews, and grow.", button: "Get started" },
      browse: {
        title: "Browse all businesses",
        listingsOne: "{{count}} listing", listingsOther: "{{count}} listings",
        searchByName: "Search by name", all: "All",
        emptyTitle: "No listings yet", emptyBody: "Be the first — sign in and add your business to Spott.", addListing: "Add a listing",
  ...
  fr: {
    translation: {
      ...
      cta: { title: "Vous avez une entreprise ?", body: "Réclamez votre place sur Spott. Connectez-vous avec les locaux et grandissez.", button: "Commencer" },
      browse: {
  ...
  es: {
    translation: {
      ...
      cta: { title: "¿Tienes un negocio?", body: "Reclama tu lugar en Spott. Conecta con locales y crece.", button: "Empezar" },
      browse: {
