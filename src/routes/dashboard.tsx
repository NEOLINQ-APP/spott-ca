  ...
  return (
    <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-card p-4">
      ...
      <div className="flex flex-wrap gap-2">
        <Link to="/business/billing" className="inline-flex items-center gap-1.5 rounded-md border border-border px-3 py-1.5 text-xs hover:bg-accent/10">
        ...
        {isActive && (
          <button onClick={openPortal} disabled={opening}
            ...
            {opening ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <ExternalLink className="h-3.5 w-3.5" />} Manage payment
          </button>
        )}
