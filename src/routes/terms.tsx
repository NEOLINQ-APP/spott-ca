      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <article className="prose prose-sm dark:prose-invert mt-8 max-w-none text-sm leading-relaxed text-foreground/90 space-y-6">
          ...
          <section>
            ...
            <p>Sellers on the Spott.ca marketplace must meet the same baseline standards used by leading global marketplaces such as Amazon. By listing a product for sale on Spott.ca you agree to the following seller obligations. Spott.ca may suspend listings, hold funds, or terminate seller accounts for any breach.</p>
            ...
            <p>The following may NOT be sold on Spott.ca:</p>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>If a seller does not respond to a legitimate dispute within 48 hours, Spott.ca may refund the buyer from escrowed funds at its sole discretion under our <strong>Spott Guarantee</strong> (modelled on the Amazon A-to-Z Guarantee).</li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>All buyer-seller communication must stay on the Spott.ca platform until the order is complete.</li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Spott.ca operates a notice-and-takedown process for rights holders. Verified IP complaints result in immediate removal of the offending listing.</li>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Spott.ca uses automated and manual review-fraud detection. Confirmed violations result in listing removal and possible permanent suspension.</li>
            </ul>
